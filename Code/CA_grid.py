...
drug_fingerprints = np.load("CA.npy")  # Shape (15, N), where N is the fingerprint length
...
for model_name in model_names:
    ...
    results_df[model_name] = categories

# Save results to an Excel file
results_df.to_excel("CA_grid.xlsx", index_label="Drug")